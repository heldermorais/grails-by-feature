...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="edit-petType" class="col-12 content scaffold-edit" role="main">
                    ...
                    <g:form resource="${this.petType}" method="PUT">
                        <g:hiddenField name="version" value="${this.petType?.version}" />
                        <fieldset class="form">
                            <f:all bean="petType"/>
                        </fieldset>
