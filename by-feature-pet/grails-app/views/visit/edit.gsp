...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="edit-visit" class="col-12 content scaffold-edit" role="main">
                    ...
                    <g:form resource="${this.visit}" method="PUT">
                        <g:hiddenField name="version" value="${this.visit?.version}" />
                        <fieldset class="form">
                            <f:all bean="visit"/>
                        </fieldset>
