...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="list-visit" class="col-12 content scaffold-list" role="main">
                    <h1><g:message code="default.list.label" args="[entityName]" /></h1>
                    <g:if test="${flash.message}">
                        <div class="message" role="status">${flash.message}</div>
                    </g:if>
                    <f:table collection="${visitList}" />

                    <g:if test="${visitCount > params.int('max')}">
                    <div class="pagination">
                        <g:paginate total="${visitCount ?: 0}" />
                    </div>
                    </g:if>
                </div>
            </section>
